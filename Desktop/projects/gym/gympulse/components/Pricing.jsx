...
export const Pricing = () => {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.fromTo(
        [taglineRef.current, headingRef.current, subRef.current],
        { opacity: 0, y: 25 },
        {
          opacity: 1,
          y: 0,
    ...
    >
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="text-center max-w-2xl mx-auto mb-20">
          ...
          >
            შექმენით ციფრული მემორიალი და შეინახეთ მოგონებები მომავალ თაობებისთვის.
          </p>
        </div>
        ...
        <div ref={footerRef} className="mt-14 text-center">
          <p className="text-xs text-gray-600 max-w-2xl mx-auto leading-relaxed">
            ყველა მემორიალი ინახება უსაფრთხოდ. პრემიუმ პაკეტი წარმოადგენს ერთჯერად გადახდას და მოიცავს სამუდამო წვდომას ყველა ფუნქციაზე.
          </p>
        </div>
