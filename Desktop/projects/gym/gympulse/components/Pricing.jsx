...
return ( <section className="py-24 bg-[#0D0D0F] relative border-t border-white/5"> <div className="max-w-5xl mx-auto px-6"> <div className="text-center max-w-2xl mx-auto mb-20"> <span className="text-xs tracking-widest uppercase text-[#D4AF37]/90 font-medium font-sans">
ტარიფები </span>
...
```
      ...
      <p className="mt-4 text-sm text-gray-500">
        შექმენით ციფრული მემორიალი და შეინახეთ მოგონებები მომავალ
        თაობებისთვის.
      </p>
    </div>
