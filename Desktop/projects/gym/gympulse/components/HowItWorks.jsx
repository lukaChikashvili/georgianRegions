...
export const HowItWorks = () => {
  const steps = [
    {
      icon: <UserPlus className="w-6 h-6 text-[#c1a362]" />,
    ...
    {
      icon: <Heart className="w-6 h-6 text-[#c1a362]" />,
    ...
    {
      icon: <Share2 className="w-6 h-6 text-[#c1a362]" />,
    ...
    <section id="how-it-works" className="py-24 bg-[#0D0D0F] relative border-t border-white/5">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="text-center max-w-2xl mx-auto mb-20">
          <span className="text-xs tracking-widest uppercase text-[#c1a362]/90 font-medium font-sans">პროცესი</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          {steps.map((step, index) => (
            <div key={index} className="relative group p-8 rounded-2xl bg-[#121214]/30 border border-white/5 backdrop-blur-sm transition-all duration-300 hover:border-[#D4AF37]/20">
              <div className="w-12 h-12 rounded-xl bg-[#1A150F] border border-[#c1a362]/20 flex items-center justify-center mb-6">
                {step.icon}
              </div>
